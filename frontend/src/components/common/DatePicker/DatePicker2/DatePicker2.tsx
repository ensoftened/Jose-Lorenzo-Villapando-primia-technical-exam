...
import { useDatePicker2 } from './useDatePicker2'
...
import { SCalendarBody, SCalendarButton, SCalendarDiv, SCalendarHeader, SCalendarIcon, SClearButton, SClearIcon, SDateGrid, SDatePanel, SDayItem, SDaysOfWeek, SDiv, SLabel, SLeftButton, SMonthAndYearSection, SMonthButton, SMonthItem, SMonthItemDiv, SMonthPanel, SPastAndFutureDateGrid, SRightButton, SSpinner, SStartAdornment, STextField, SYearButton, SYearItem, SYearItemDiv, SYearPanel } from './datePicker2.style'
