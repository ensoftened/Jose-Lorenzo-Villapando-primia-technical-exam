...
export const useDatePicker2 = (props: DatePickerProps) => {
  const {
    color,
    disabled,
    endAdornment,
  ...
  const years: number[] = useMemo(
    () => generateListOfNumbers(Number(startYear), Number(endYear)),
    []
  );
  ...
  const [isRightButtonOnMouseOver, setIsRightButtonOnMouseOver] =
    useState(false);
  const [isRightButtonOnMouseDown, setIsRightButtonOnMouseDown] =
    useState(false);
  ...
  const [isCalendarButtonOnMouseOver, setIsCalendarButtonOnMouseOver] =
    useState(false);
  const [isCalendarButtonOnMouseDown, setIsCalendarButtonOnMouseDown] =
    useState(false);
  ...
  const [leftAndRightButtonClicked, setleftAndRightButtonClicked] =
    useState(true);
  const [leftAndRightButtonClickedIndex, setleftAndRightButtonClickedIndex] =
    useState(0);
  ...
  const startingDay: number = new Date(
  ...
  const handleTextFieldBlur = () => {
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////console.log("BLURRR")
    if (
      /^(((0[1-9]|1[012])\/(?!00|29)([012]\d)|(0[13-9]|1[012])\/(29|30)|(0[13578]|1[02])\/31)\/(18|19|20|9999)\d{2}|02\/29\/((18|19|20)(0[48]|[2468][048]|[13579][26])|2000|9999))$/.test(
        stateValue
      ) == false ||
