...
import { SClearButton, SClearIcon, SDiv, SLabel, SSpinner, SStartAdornment, STextArea } from './textArea2.style'
...
import { useTextArea2 } from './useTextArea2'
...
export default React.memo(TextArea2)